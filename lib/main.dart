...
void main() async{
  ...
  for (var s in suppliers) {
    print("Supplier: ${s.supplierName}, Purchases: ${s.totalPurchases}, Paid: ${s.totalPaid}, Balance: ${s.balance}");
  }

  // 🔹 Test Product Reports
  final products = await reportRepo.getProductReports();
  for (var p in products) {
    print("Product: ${p.productName}, Qty: ${p.totalQtyPurchased}, Spent: ${p.totalSpent}");
  }
